...
* [DOCUMENTATION.md](DOCUMENTATION.md) — architecture, extension seam, protocol details
* [USER-GUIDE.md](USER-GUIDE.md) — feature-by-feature prose walkthrough
* [ATTACK.md](ATTACK.md) — adversarial playbook and what the differential runs found
* [DEFENSE-MAP.md](DEFENSE-MAP.md) — subject + evaluation obligations → the command that proves each
* [history_cmd.md](history_cmd.md) — IRC command history and rationale
