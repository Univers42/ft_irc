...
void Log::banner(const std::string& title) { render('b', title); }

void Log::info(const std::string& msg) { render('i', msg); }

void Log::success(const std::string& msg) { render('s', msg); }

void Log::warn(const std::string& msg) { render('w', msg); }

void Log::error(const std::string& msg) { render('e', msg); }
